		...
		<div className="row">
			<div className="col s12">
				<button className="btn waves-effect waves-light btn-large"
					type="button" onClick={this.props.lahetaLisays }>Lisää
					täyte</button>
			</div>
		</div>
		</form>
...
var PizzanLisays = React.createClass({
	...
	laskeValitut: function() {
		...
		this.setState({valittuja: valittuja });
		if (valittuja > 4) {
				...
				<form id="lisaysformi">
					...
					<div className="row">
						...
						<div className="input-field col s12 m3 l3">
							<input type="number" className="validate" min="0" step="0.05" name="pizzahinta" id="pizzahinta" />
							<label htmlFor="pizzahinta" data-error="Virhe">Pizzan hinta</label>
						</div>
						<div className="input-field col s12">
						<textarea className="materialize-textarea" name="pizzakuvaus" id="pizzakuvaus" length="255"></textarea>
					...
					<button className="btn waves-effect waves-light btn-large" type="button" onClick={this.props.lisaaPizza }>Lisää pizza</button>
					</div>
				</form>
				</div>
			</div>
